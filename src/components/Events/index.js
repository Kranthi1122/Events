...
class Events extends Component {
  ...
  statusFunction = id => {
    const filteredItem = eventsList.filter(eachItem => id === eachItem.id)
    this.setState({display: filteredItem[0].registrationStatus})
  }
    ...
    return (
      <div className="main-bg">
        ...
        <div className="results-bg">
          <ActiveEventRegistrationDetails display={display} />
        </div>
      </div>
    )
  }
